...
const WhyLockItLending = () => {
  useCanonical('https://www.lockitlending.com/why-lock-it-lending');
  return (
        ...
        "
              >
                ...
                <p className="text-base md:text-lg leading-relaxed">
                  ...
                  innovators, industry leaders, and top-performing professionals shaping the future
                  of home financing. Based in Texas and recognized nationally, our team thrives on
                  excellence, collaboration, and growth, making Lock It Lending the ideal place to
                  build a rewarding career in mortgage lending.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="p-5 sm:p-6 md:p-8 lg:p-10">
                  ...
                  <ul className="space-y-3 text-gray-900">
                    ...
                    <li className="flex gap-3">
                      <span className="mt-2 h-2.5 w-2.5 rounded-full bg-[#cca249] shrink-0" />
                      <span>
                        <strong>Lyn Ha</strong> – Recognized as a Top 400 Loan Officer in the Nation
                      </span>
                    </li>
                  </ul>
                </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mt-6 sm:mt-8 bg-[#cca249] text-white rounded-xl px-5 sm:px-7 md:px-8 py-6 sm:py-7 md:py-8 shadow">
              <p className="text-sm sm:text-base md:text-lg leading-relaxed">
                ...
                technology and ongoing training, we empower our team to succeed and maximize earning
                potential.
              </p>
            </div>
          </div>
