            ...
            <div className="text-6xl text-center mb-10">
              ...
              <div className="text-center text-gray-800 mb-10w-full max-w-4xl mx-auto mb-16">
                ...
                <p className="text-base text-gray-800 font-normal text-left max-w-7xl mx-auto mb-10">
                  ...
                  families across the region. At <strong> Lock it Lending </strong>, this tragedy
                  hit especially close to home. Our team heard the news through a personal
                  connection. My daughter Natalie told me one of the girls affected was the little
                  sister of her soccer teammate. For the past two summers, both of our kids, Ty and
                  Natalie, attended a beloved <strong> Texas summer camp near Kerrville </strong>. I
                  remember watching the camp’s photo app like a hawk, spotting them kayak, swimming,
                  dancing, and making lifelong friends. Every pickup day was filled with joy, hugs,
                  and “I don’t want to go home” smiles on their sun-kissed faces. That’s why this
                  loss is so deeply personal. Parents send their kids to camp to experience joy,
                  growth, and connection, not tragedy. The pain these families are experiencing is
                  unimaginable.
                </p>
              ...
              <div className="text-center text-gray-800 mb-10 w-full max-w-4xl mx-auto">
                ...
                <p className="text-base text-gray-800 font-normal italic text-left max-w-7xl mx-auto mb-10">
                  ...
                  While we know that her joy is now eternal and her faith has become sight, our
                  hearts are shattered by this loss… We thank you for your prayers and support.”
                </p>
                <p className="text-base text-gray-800 font-bold text-left max-w-7xl mx-auto mb-16">
                ...
                <p className="text-base text-gray-800 text-left max-w-7xl mx-auto">
                  ...
                  long lines of <strong> H-E-B trucks </strong> heading to the disaster zone. It was
                  a powerful symbol of Texas businesses and communities rallying together. At{' '}
                  <strong> Lock It Lending </strong>, we felt called to help however we could. One
                  of our own, <strong> Loan Officer Travis Spencer </strong>, is currently on the
                  ground in Kerrville. He has been working 14 to 16 hour days to support cleanup and
                  recovery efforts. His passion for service goes beyond the mortgage industry.
                  Travis leads a nonprofit organization, <strong> SteeleCroft </strong>, a
                  registered <strong> 501(c)(3) </strong>focused on disaster relief and community
                  rebuilding. To support Travis and the Kerrville community, Lock It Lending has
                  donated <strong> $3,000 </strong>to{' '}
                  <strong> SteeleCroft’s flood relief mission. </strong>
