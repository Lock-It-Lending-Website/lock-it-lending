...
export default function LoanPrograms() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://lock-it-lending-backend.onrender.com/api/send-email', {
        method: 'POST',
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="text-sm text-gray-600 flex gap-3 items-start">
                    ...
                    <p>
                      ...
                      Terms of Use, Privacy Policy, Email Policy, and provide consent to receive
                      text messages for important notifications. Message frequency varies. Message
