...
export const resourcesData: ResourceArticle[] = [
  {
    ...
    thumbnailUrl: `${process.env.PUBLIC_URL}/Be-Aware-of-Predatory-Lending-Practices.jpg`,
    content: `<p class="chakra-text css-2a5fp1">Learn how to protect yourself from Predatory Lending from Scotsman Guide Rising Star Hanh Dao and RedFin! Whether you’ve borrowed before from a lender or just stepped into the world of home loans, understanding predatory lending is crucial to protect yourself from falling prey to unfair and financially devastating traps. Uncover the red flags, explore the legal aspects, and equip yourself with valuable insights to steer clear of predatory lending and secure your dream home.</p>`,
  },
  {
